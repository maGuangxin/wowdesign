	...
	<div class="recommendall">
		<div class='recommend' v-for="data,index in this.$store.state.imglist.modules" v-if="$store.state.imglist.modules[0]===data?false:true">
			<div class="recommendinside">				
				...
				<div class="onebannner" v-for="info in data.moduleContent.banners" v-if="data.moduleContent.banners.length<=2">
					<img  :src="info.bannerImgSrc">
				</div>
				<div class="bannerbox">				
					<div v-for="info in data.moduleContent.banners" v-if="data.moduleContent.banners.length>2" class="floatbanners">
